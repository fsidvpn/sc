...
vlesslink1="vless://${uuid}@${domain}:$tls?path=/fsid&security=tls&encryption=none&type=ws#${user}"
vlesslink2="vless://${uuid}@${domain}:$none?path=/fsid&encryption=none&type=ws#${user}"
